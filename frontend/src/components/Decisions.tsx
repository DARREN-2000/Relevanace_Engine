...
export const Decisions = () => {
  ...
  const handleRunNba = () => {
    axios
      .post("http://localhost:8000/api/decisions/next-best-action", {
        user_id: userId,
      })
  ...
  const handleFetchHistory = () => {
    axios
      .get(`http://localhost:8000/api/decisions/${userId}`)
  ...
  return (
    <div className="page-container">
      ...
      <div style={{ marginBottom: "20px" }}>
        ...
        />
        <button onClick={handleRunNba} style={{ marginRight: "10px" }}>
          Run NBA
        </button>
      ...
      {nbaResult && (
        ...
        >
          ...
          <p>
            <strong>Channel:</strong> {nbaResult.channel}
          </p>
          <p>
            <strong>Action:</strong> {nbaResult.action}
          </p>
          <p>
            <strong>Reason:</strong> {nbaResult.reason}
          </p>
          <p>
            <strong>Suppressed:</strong> {nbaResult.suppressed ? "Yes" : "No"}
          </p>
        </div>
      )}
